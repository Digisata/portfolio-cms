...
pub async fn find(db: &Database, limit: i64, page: i64) -> mongodb::error::Result<Vec<Social>> {
    let collection = db.collection::<SocialDocument>("social");
...
pub async fn find_by_id(db: &Database, oid: ObjectId) -> mongodb::error::Result<Option<Social>> {
    let collection = db.collection::<SocialDocument>("social");
...
pub async fn insert(db: &Database, input: Json<SocialInput>) -> mongodb::error::Result<String> {
    let collection = db.collection::<Document>("social");
...
pub async fn delete_by_id(db: &Database, oid: ObjectId) -> mongodb::error::Result<Option<Social>> {
    let collection = db.collection::<SocialDocument>("social");

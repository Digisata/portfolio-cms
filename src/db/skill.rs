...
pub async fn find(db: &Database, limit: i64, page: i64) -> mongodb::error::Result<Vec<Skill>> {
    let collection = db.collection::<SkillDocument>("skill");
...
pub async fn find_by_id(db: &Database, oid: ObjectId) -> mongodb::error::Result<Option<Skill>> {
    let collection = db.collection::<SkillDocument>("skill");
...
pub async fn insert(db: &Database, input: Json<SkillInput>) -> mongodb::error::Result<String> {
    let collection = db.collection::<Document>("skill");
...
pub async fn delete_by_id(db: &Database, oid: ObjectId) -> mongodb::error::Result<Option<Skill>> {
    let collection = db.collection::<SkillDocument>("skill");
